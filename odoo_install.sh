...
# Basado en el script original de Yenthe Van Ginneken y actualizado para Odoo 18
################################################################################
...
echo "Creando el directorio de addons personalizados en /odoo18/custom/addons..."
sudo mkdir -p /odoo18/custom/addons

echo "Estableciendo los permisos para $OE_HOME y $OE_HOME_EXT..."
sudo chown -R $OE_USER:$OE_USER $OE_HOME
sudo chown -R $OE_USER:$OE_USER $OE_HOME_EXT
sudo chown -R $OE_USER:$OE_USER /odoo18/custom/addons
...
addons_path=${OE_HOME_EXT}/addons,/odoo18/custom/addons
