#!/bin/bash
################################################################################
# Script para instalar Odoo 16 en Ubuntu 20.04 LTS
# Basado en el script original de Yenthe Van Ginneken y actualizado para Odoo 16
################################################################################
...
sudo mkdir -p /odoo16/custom/addons
...
sudo chown -R $OE_USER:$OE_USER /odoo16/custom/addons

#--------------------------------------------------
# Validar y Descargar requirements.txt
#--------------------------------------------------
echo -e "\n---- Validando archivo requirements.txt ----"
wget https://raw.githubusercontent.com/adlacademy/odoo_install/refs/heads/16.0/requirements.txt -O $OE_HOME_EXT/requirements.txt
...
addons_path=${OE_HOME_EXT}/addons,/odoo16/custom/addons
